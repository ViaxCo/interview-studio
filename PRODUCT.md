...
Rigorous, calm, practical. The product should feel like a serious study tool: direct, trustworthy, and quietly encouraging.

## Anti-references

Avoid generic AI SaaS dashboard styling: oversized metric cards, decorative gradients, ornamental stats, and heavy card grids that make a study tool feel like a landing page. Avoid flashy coaching-app gamification that distracts from focused practice.

## Design Principles

- Practice before reveal: the interface should encourage recall before showing the answer.
